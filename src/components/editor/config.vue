          ...
          <el-row :gutter="20" style="margin-top: 12px;" v-show="editorSettings.parentBg === 1">
            ...
            <el-col :span="24" v-show="chartData.bgimage">
             ...
             <el-col :span="24"  v-show="chartData.bgimage" style="margin-top: 16px">
               <el-button type="danger" plain @click="handleScreenBgDelete" style="width: 100%">
                  删除
               </el-button>
             </el-col> 
          </el-row>
       ...
       <div class="panel" v-show="thisKey=='data' && currentElement.data.type == 'chart'">
         <div class="config-box">
           ...
           <el-select v-if="currentElement.data.datacon.type == 'connect'"
            ...
            @change="handleChartDataChange"
            style="width: 100%; margin-bottom: 10px;">
            <el-option v-for="item in connectList" :label="item.name" :value="item._id" :key="item._id"></el-option>
          </el-select>   
       ...
       <div class="panel" v-show="thisKey=='data' && currentElement.data.type == 'text'">
         ...
         <div class="config-box">
           ...
           <el-select v-model="currentElement.data.datacon.fontFamily"
              ...
              <el-option-group label="英文字体">
                <el-option label="Molengo" value="Molengo">
                 ...
                 <el-option label="Lobster" value="Lobster">
                  <span :style="{fontFamily: 'Lobster'}">Molengo</span>
                </el-option>  
              </el-option-group>
            ...
            <el-row :gutter="20">
              <el-col :span="24">
                <div class="btn" :class="{active: currentElement.data.datacon.bold}" 
                  @click="currentElement.data.datacon.bold = !currentElement.data.datacon.bold">
                  <i class="iconfont icon-bold"></i>
                </div>

                <div class="btn" :class="{active: currentElement.data.datacon.italic}" 
...
.public_config, .component-config .panel {
  flex: 1;
  overflow-y: scroll;
}
